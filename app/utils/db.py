        ...
        with conn.cursor() as cursor:
            cursor.execute("""
                INSERT INTO callbot_sessions (
                    session_id, client_id, lead_id, created_at, updated_at
                ) VALUES (%s, %s, %s, %s, %s)
...
async def save_session(
    ...
    await asyncio.to_thread(_save_session_sync, session_id, client_id, lead_id, timestamp)
...
def _get_session_list_sync(
    ...
    try:
        with conn.cursor(pymysql.cursors.DictCursor) as cursor:
            query = [
                "SELECT session_id, client_id, lead_id, created_at, updated_at",
